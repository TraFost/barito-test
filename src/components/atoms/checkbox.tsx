...
export default function Checkbox({ checked, setChecked, label }: Props) {
	return (
		<div className="relative flex items-center">
			...
			/>
			<label
				className="cursor-pointer pl-3 text-custom-gray peer-disabled:cursor-not-allowed peer-disabled:text-slate-400 break-words"
				htmlFor="id-c01"
			>
				{label}
			</label>
